<div align="center">
  <h1>Dmitrii Dark</h1>
  <p><strong>Full-Cycle Software Engineer | Go & TypeScript</strong></p>
  <p>Specialized in High-Performance Systems, Low-Latency APIs, and Interactive 3D Web.</p>
 
  <a href="https://ddark.dev">🌐 Portfolio</a> • 
  <a href="mailto:hello@ddark.dev">📧 Contact</a> • 
  <a href="https://linkedin.com/in/dmitriidark">💼 LinkedIn</a>
</div>
...
- **Architecture:** WebSocket collectors -> Redis (Hot Data/Indicators) -> TimescaleDB (Historical).
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=go,ts,postgres,redis,docker,linux,react,nextjs,blender,figma&perline=10" />
</div>
